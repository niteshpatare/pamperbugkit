                ...
                <div className='hidden md:block'>
                  <div className='ml-10 flex items-baseline space-x-4'>
                    ...
                    <NavLink
                      ...
                      className='bg-gray-900 hover:bg-gray-700 hover:text-white text-white px-3 py-2 rounded-md text-sm font-medium'
                    >
                      Explore and Enjoy
                    </NavLink>
          ...
          <div className='max-w-8xl mx-auto py-3 px-3 sm:px-6 lg:px-8'>
            <div className='flex items-center justify-between flex-wrap'>
              <div className='w-full flex-1 flex items-center'>
                <span className='flex p-4 rounded-lg bg-gray-800'>
                ...
                <p className='ml-3 font-medium text-white truncate'>
                  ...
                  <span className='hidden md:inline'>
                    ...
                    <a
                      href='https://kayakcm.com'
                      className='flex items-centertext-sm font-small text-xs text-gray-900'
                    >
                      Crafted by KayakCM.com
                    </a>
                    <a
                      href='https://www.pandagoesfishing.com'
                      className='flex items-centertext-sm font-small text-xs text-gray-900'
                    >
