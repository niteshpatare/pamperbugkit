        ...
        <Fragment>
            <header className="bg-white shadow">
                ...
                <h1 className="text-3xl font-bold text-gray-900">
                    <span className="text-prm font-extrabold leading-normal">Happiness</span> <span className="text-sec"> Crate</span>
                </h1>
                </div>
            </header>
            <main>
                    ...
                    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 py-4 px-4 gap-4">
                        <div className="timeline py-16">
                            <div className="container left">
                                ...
                                <img className="rounded h-32 w-full object-cover sm:h-32 md:h-32 lg:w-full lg:h-full" style={{"vertical-align":"top"}} src={ order } alt=""/>
                                </div>
                            </div>
